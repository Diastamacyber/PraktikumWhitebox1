...
public class ProdukTest {
    ...
    void testKurangiStokNegatif() {
        Exception exception =
                assertThrows(IllegalArgumentException.class, () -> produk.kurangiStok(-5));
    ...
    void testKurangiStokTidakMencukupi() {
        Exception exception =
                assertThrows(IllegalArgumentException.class, () -> produk.kurangiStok(15));
    ...
    void testTambahStokNegatif() {
        Exception exception =
                assertThrows(IllegalArgumentException.class, () -> produk.tambahStok(-5));
        assertEquals("Jumlah harus positif", exception.getMessage());
    }
    ...
    @Test
    @DisplayName("Test equals dan hashCode - kode sama")
    ...
    @Test
    @DisplayName("Test equals - kode berbeda")
    void testEqualsKodeBerbeda() {
        Produk produk1 = new Produk("PROD001", "Laptop", "Elektronik", 1000000, 5, 2);
        Produk produk2 = new Produk("PROD002", "Mouse", "Elektronik", 50000, 10, 5);
        assertNotEquals(produk1, produk2);
    }

    @Test
    @DisplayName("Test equals - objek null dan beda class")
    void testEqualsNullDanBedaClass() {
        assertNotEquals(produk, null);
        assertNotEquals(produk, "string"); // beda class
    }

    @Test
    @DisplayName("Test toString menghasilkan representasi string")
    void testToString() {
        String hasil = produk.toString();
        assertTrue(hasil.contains("Produk{"));
        assertTrue(hasil.contains("kode='PROD001'"));
        assertTrue(hasil.contains("Laptop Gaming"));
    }
}
